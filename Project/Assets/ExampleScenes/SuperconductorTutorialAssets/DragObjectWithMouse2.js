...
function FixedUpdate() {
    if (!Input.GetMouseButton(0)) {
        ...
        startPoint = Input.mousePosition;
        rigidbody.AddTorque(Vector3(0.0f, -0.05f*change.x, 0.05f*change.y), ForceMode.Impulse);
        
        rigidbody.AddForce(-0.05f * change.magnitude * Camera.main.ScreenPointToRay(Input.mousePosition).direction);
